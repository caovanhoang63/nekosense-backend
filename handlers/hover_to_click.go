...
func (g *GinHandler) onHoverToClick(c context.Context, event *models.Event) error {
	_, err := g.db.Collection("hover_to_click").InsertOne(c, event)
	if err != nil {
		log.Println(err)
		return err
	}
...
func (g *GinHandler) GetHoverToClick() gin.HandlerFunc {
	return func(c *gin.Context) {
		cursor, err := g.db.Collection("hover_to_click").Find(c, bson.M{})
		if err != nil {
